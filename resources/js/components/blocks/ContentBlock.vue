<template>
    <div class="relative group">
        ...
        <transition name="fade">
            <div
                v-if="isEditing"
                class="absolute -top-14 left-1/2 z-20 flex -translate-x-1/2 items-center gap-1 rounded-full border border-slate-200 bg-slate-900/95 px-2 py-1 text-white shadow-xl"
            >
                <button
                    type="button"
